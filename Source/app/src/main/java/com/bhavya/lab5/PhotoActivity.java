    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == TAKE_PHOTO_CODE && resultCode == RESULT_OK) {
            ...
            try{
                ...
                Thumbnailing = ThumbnailUtils.extractThumbnail(map,Size_Of_Image,Size_Of_Image);
            }
            catch (Exception ex){
                ex.printStackTrace();
            }
            try {
                ...
                Thumbnailing.compress(Bitmap.CompressFormat.PNG, 100, out);
                out.flush();
                out.close();
            } catch (Exception e) {
            }
